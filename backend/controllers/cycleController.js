...
exports.createCycle = async (req, res) => {
    ...
    console.log("createCycle called - headers:", {
        authorization: req.header("Authorization"),
        contentType: req.header("Content-Type"),
    });
    console.log("createCycle called - user:", req.user);
    console.log("createCycle called - body:", req.body);
    try {
        const cycle = new Cycle({
            name,
            model,
        ...
        console.error("createCycle error:", err && err.stack ? err.stack : err);
